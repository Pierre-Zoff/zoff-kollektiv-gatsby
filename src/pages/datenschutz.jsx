...
const IndexPage = () => (
  <Layout>
    <div className="container grid grid-cols-12 col-gap-2 sm:col-gap-10">
      <div className="col-span-10 col-start-2">
        ...
        <p>
          ...
          und in Übereinstimmung mit den für den Berliner Mieterverein e.V.
        ...
        <p>
          Die Datenschutzerklärung des Berliner Mieterverein e.V. beruht auf den
        ...
        <p>
          ...
          Mieterverein e.V. daher einerseits statistisch und ferner mit dem Ziel
        ...
        <ul style={{ listStyle: "none" }}>
          ...
          <li>
            ...
            <p>
              ...
              für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter des
              Berliner Mieterverein e.V. wird veranlassen, dass dem
              Löschverlangen unverzüglich nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten vom Berliner Mieterverein e.V.
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft der Berliner Mieterverein e.V. unter
          ...
          <li>
            ...
            <p>
              ...
              Mitarbeiter des Berliner Mieterverein e.V. wird die Einschränkung
          ...
          <li>
            ...
            <p>
              ...
              die betroffene Person jederzeit an einen Mitarbeiter des Berliner
              Mieterverein e.V. wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              Verarbeitet der Berliner Mieterverein e.V. personenbezogene Daten,
              ...
              Person gegenüber dem Berliner Mieterverein e.V. der Verarbeitung
              für Zwecke der Direktwerbung, so wird der Berliner Mieterverein
              e.V. die personenbezogenen Daten nicht mehr für diese Zwecke
              verarbeiten.
            </p>
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die beim Berliner
              Mieterverein e.V. zu wissenschaftlichen oder historischen
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter des Berliner Mieterverein e.V.
